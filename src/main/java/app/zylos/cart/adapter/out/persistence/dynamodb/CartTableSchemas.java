...
public final class CartTableSchemas {
    ...
    public static final StaticImmutableTableSchema<ActiveCartPointerItem, ActiveCartPointerItem.Builder> ACTIVE_CART_POINTER =
        StaticImmutableTableSchema.builder(ActiveCartPointerItem.class, ActiveCartPointerItem.Builder.class)
